...
(function (BotStateType) {
    ...
    BotStateType["CONVERSTAION_ID"] = "CONVERSATION_ID";
    ...
    BotStateType["ON_ENDSESSION_CALLED"] = "ON_ENDSESSION_CALLED";
...
class BotState {
    ...
    _SetAppAsync(app) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield this.SetOnEndSessionCalled(false);
    ...
    GetConversationId() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.GetStateAsync(BotStateType.CONVERSTAION_ID);
        });
    }
    SetConversationId(conversationId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            yield this.SetStateAsync(BotStateType.CONVERSTAION_ID, conversationId);
        });
    }
    // ------------------------------------------------
    //  EDITING_PACKAGE
    ...
    GetEndSessionCalled() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const called = yield this.GetStateAsync(BotStateType.ON_ENDSESSION_CALLED);
            return (called ? called : false);
        });
    }
    SetOnEndSessionCalled(called) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            called = called ? called : false;
            yield this.SetStateAsync(BotStateType.ON_ENDSESSION_CALLED, called);
        });
    }
    // ------------------------------------------------
    // LAST_ACTIVE
    ...
    SetSessionAsync(sessionId, logDialogId, conversationId, inTeach, orgSessionId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!existingOrigSesionId) {
                yield this.SetOrgSessionId(orgSessionId);
            }
            yield this.SetOnEndSessionCalled(false);
            yield this.SetConversationId(conversationId);
            yield this.SetLastActive(new Date().getTime());
            yield this.SetInTeach(inTeach);
            yield this.SetMessageProcessing(null);
        });
    }
    EndSessionAsync() {
    ...
    CreateConversationReference(userName, userId, conversationId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            let conversationReference = {
                ...
                serviceUrl: ConversationLearner_1.ConversationLearner.options.DOL_SERVICE_URL
            };
