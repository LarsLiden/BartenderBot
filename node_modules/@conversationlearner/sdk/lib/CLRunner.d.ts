...
export declare class CLRunner {
    ...
    RenderTemplateAsync(conversationReference: Partial<BB.ConversationReference>, clRecognizeResult: CLRecognizerResult): Promise<Partial<BB.Activity> | string | null>;
    SendIntent(intent: CLRecognizerResult): Promise<void>;
