...
export declare class BotMemory {
    ...
    private memory;
    filledEntities: FilledEntityMap;
    private constructor();
    ...
    private Set();
    RestoreFromMap(filledEntityMap: FilledEntityMap): Promise<void>;
    ClearAsync(): Promise<void>;
    private Remember(entityName, entityId, entityValue, isBucket?, builtinType?, resolution?);
    ...
    private MemoryValues(entityName);
}
