...
class CLRunner {
    ...
    CallEntityDetectionCallback(text, predictedEntities, memory, allEntities) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            let prevMemories = new CLM.FilledEntityMap(yield memory.BotMemory.FilledEntityMap());
            ...
            let memoryManager = yield this.CreateMemoryManagerAsync(memory, allEntities, prevMemories);
            // If bot has callback, call it
            if (this.entityDetectionCallback) {
                try {
                    yield this.entityDetectionCallback(text, memoryManager);
                    // Update Memory
                    yield memory.BotMemory.RestoreFromMap(memoryManager.curMemories);
                }
                catch (err) {
    ...
    CallSessionStartCallback(memory, appId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (appId && this.onSessionStartCallback) {
                let entityList = yield this.clClient.GetEntities(appId);
                let memoryManager = yield this.CreateMemoryManagerAsync(memory, entityList.entities);
    ...
    RenderTemplateAsync(conversationReference, clRecognizeResult, inTeach = false) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    SendIntent(intent, inTeach = false) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            let message = yield this.RenderTemplateAsync(conversationReference, intent, inTeach);
            if (message != null) {
    ...
    TakeLocalAPIAction(apiAction, filledEntityMap, memory, allEntities) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            let memoryManager = yield this.CreateMemoryManagerAsync(memory, allEntities);
            try {
                try {
    ...
    EntityDiscrepancy(userInput, round, memory, entities) {
        ...
        let newEntities = Object.keys(memory.BotMemory.filledEntityMap.map).map(k => memory.BotMemory.filledEntityMap.map[k]);
