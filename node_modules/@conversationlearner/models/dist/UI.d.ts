...
export declare const CL_USER_NAME_ID = "CLTrainer";
export declare const MEMORY_KEY_HEADER_NAME = "x-conversationlearner-memory-key";
/** Indicates whether END_SESSION was called on the running Session */
export declare enum SessionEndState {
